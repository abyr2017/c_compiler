...
//not in : p,v,b,e,c
	...
	/**-----------------------------------if or integer or litteral starting with if ||ineteger-------------------------*/
...
//not in : p,v,b,e,c,i
	...
	/**-----------------------------------------do or litteral starting with do -----------------------------------*/
...
//not in :p,v,b,e,c,i,d

	/**-----------------------------then or litteral starting with then -----------------------------------*/
